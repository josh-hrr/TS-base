...
var getPokemon = function (pokemonId) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, axios_1.default.get("https://pokeapi.co/api/v2/pokemon/".concat(pokemonId))];
            case 1:
                response = _a.sent();
...
getPokemon(1)
    .then(function (resp) { return console.log(resp.sprites.front_default); })
